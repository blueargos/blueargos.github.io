...
(function () {
  ...
  var I18N = {
    ko: {
      "meta.title": "BlueArgos — 깨끗한 과속 카메라 알림",
      "meta.description": "개인정보 입력 없이, 광고 없이, 데이터 통신과 배터리 사용을 최소화한 깨끗한 과속 단속 카메라 알림 앱 BlueArgos.",
      "meta.ogDescription": "개인정보 없이, 광고 없이, 배터리도 아끼며 조용히 지켜보는 과속 카메라 알림 앱.",
      "nav.ariaLabel": "주요 섹션",
      "nav.principles": "차별점",
      "nav.how": "동작 방식",
      ...
      "card2.h3": "개인정보 입력 없음",
      "card2.p": "회원 가입, 로그인, 차량 정보 입력도 필요 없습니다. App을 설치하고 바로 사용하면 됩니다. Android의 루틴, iOS의 자동화 기능을 사용하면 차량 탑승 시 자동 실행, 하차 시 자동 종료됩니다.",
      ...
      "how.h2": "동작 방식",
      "how.p": "과속 카메라가 가까워질 때만 목소리를 냅니다. 나머지는 조용합니다.",
      ...
      "footer.note": "과속 카메라 위치 데이터 출처: 경찰청 · 공공데이터포털(data.go.kr), 공공누리 제1유형(출처표시).",
